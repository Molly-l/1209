...
# [r][c-1]  [c-1][r]
    ...
    def __move_left(self):
        for line in self.__map:#循环将四行左移相加
    ...
    #方阵转置
    def __square_matrix_transpose(self):#sqr_matrix: 二维列表类型的方阵
    ...
    def generate_new_number(self):
        ...
        if len(self.__list_empty_location) == 0:#0是假
            return
    ...
    #获取空位置
    def __get_empty_location(self):# 每次统计空位置，都先清空之前的数据，避免影响本次数据．
    ...
    #游戏是否结束
    def is_game_over(self):#False表示没有结束 True 表示结束
        # 是否具有空位置
